...
lateinit var update:Button
    ...
    override fun onCreateView(
        ...
        update=rootview.findViewById<Button>(R.id.updateprofile)
        ...
        update.setOnClickListener{
            /*val email_text = emailedit!!.text.toString().trim()
            val fullname_text = fullnameedit!!.text.toString().trim()
            val phone_text = phoneedit!!.text.toString().trim()
            val matricule_text = matricul!!.text.toString().trim()
            val adresse_text = addressedit!!.text.toString().trim()

            println("########################################"+emailedit!!.text.toString())*/
