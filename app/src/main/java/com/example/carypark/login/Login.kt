...
println(response.body())
    ...
    private fun showDialogOne() {
        ...
        dialog.setContentView(R.layout.itemloginsocial)
        val facebook=dialog.findViewById<LinearLayout>(R.id.facebook)
        val gmail=dialog.findViewById<LinearLayout>(R.id.gmail)
        facebook?.setOnClickListener{


        }
        gmail?.setOnClickListener{
            Toast.makeText(this, "test gmail", Toast.LENGTH_SHORT).show()
        }
        dialog.show()
    }
