...
import com.example.carypark.Service.RetrofitApi
import com.example.carypark.fragements.latitude0
import com.example.carypark.fragements.longitude0
import com.example.carypark.fragements.mSharedPref
import com.example.carypark.login.EMAIL
...
class HistoryAdapter (val reservationList: MutableList<Reservation>) :  RecyclerView.Adapter<HistoryAdapter.viewHolder>()
{
    ...
    override fun onBindViewHolder(holder: viewHolder, position: Int) {
        ...
        val user = reservationList[position].userFromPark
        ...
        holder.qr.setOnClickListener {
           ...
           val image=dialog.findViewById<ImageView>(R.id.generate)
            ...
            fun generateQj() {
                val data = Qrj( reservationList[position].user?.car,reservationList[position].dateEntre,reservationList[position].dateSortie
                ,reservationList[position].parking?.prix,reservationList[position].parking?.adresse)
